...
export default function SaleTable({ sales, onEdit, onDelete }: SaleTableProps) {
    return (
            ...
            <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                    <tr>
                        ...
                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">ลูกค้า (CID)</th>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                    {sales.length === 0 ? (
                        ...
                        sales.map((sale) => (
                            <tr key={sale.SID} className="hover:bg-gray-50 transition-colors">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{sale.CID}</td>
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{sale.Staff}</td>
